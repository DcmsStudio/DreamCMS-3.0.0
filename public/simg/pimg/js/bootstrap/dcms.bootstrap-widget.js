...
(function ( $, window, document, undefined )
{
	...
	Plugin.prototype = {
		...
		_settings: function ()
		{
			...
			if ( storage && self.o.localStorage ) {
				...
				if ( self.o.ajaxnav === true ) {
					...
					keySettings = 'dcmsWidgets_settings_' + location.pathname + '_' + self.objId;
					getKeySettings = localStorage.getItem( keySettings );

					keyPosition = 'dcmsWidgets_position_' + location.pathname + '_' + self.objId;
					getKeyPosition = localStorage.getItem( keyPosition );
				...
				self.obj.find( self.o.widgets )
					.each( function ()
					{
						...
						storeSettingsStr['collapsed'] = ($( this )
							.hasClass( 'dcmswidget-collapsed' ) ? 1 : 0);
		...
		init: function ()
		{
			...
			if ( storage && self.o.localStorage && getKeySettings ) {
				...
				for ( var key in jsonSettings.widget ) {
					...
					if ( jsonSettings.widget[key].style ) {
						//console.log("test");
						widgetId.removeClassPrefix( 'dcmswidget-color-' )
					...
					if ( jsonSettings.widget[key].collapsed == 1 ) {
						widgetId.addClass( 'dcmswidget-collapsed' )
							.children( 'div' )
							.hide( 1 );
					}
			...
			self.widget.each( function ()
			{
				...
				if ( !thisHeader.parent().attr( 'role' ) ) {
					...
					if ( tWidget.data( 'widget-collapsed' ) === true ) {
						tWidget.addClass( 'dcmswidget-collapsed' )
							.children( 'div' )
							.hide();
					}
					...
					//	thisHeader.prepend('<i class="dcmswidget-icon '+tWidget.data('widget-icon')+'"></i>');
					//}
					...
					if ( self.o.customButton === true && tWidget.data( 'widget-custombutton' ) ===
						...
						var customBtn =
							'<a href="javascript:void(0);" class="button-icon dcmswidget-custom-btn"><i class="' +
					...
					if ( self.o.deleteButton === true && tWidget.data( 'widget-deletebutton' ) ===
						undefined ) {
						var deleteBtn =
							'<a href="javascript:void(0);" class="button-icon dcmswidget-delete-btn" rel="tooltip" title="Delete" data-placement="bottom"><i class="' +
					...
					if ( self.o.editButton === true && tWidget.data( 'widget-editbutton' ) === undefined ) {
						var editBtn =
							'<a href="javascript:void(0);" class="button-icon dcmswidget-edit-btn" rel="tooltip" title="Edit Title" data-placement="bottom"><i class="' +
					...
					if ( self.o.fullscreenButton === true && tWidget.data( 'widget-fullscreenbutton' ) ===
						undefined ) {
						var fullscreenBtn =
							'<a href="javascript:void(0);" class="button-icon dcmswidget-fullscreen-btn" rel="tooltip" title="Fullscreen" data-placement="bottom"><i class="' +
					...
					if ( self.o.colorButton === true && tWidget.data( 'widget-colorbutton' ) ===
						undefined ) {
						var widgetcolorBtn =
							'<a data-toggle="dropdown" class="dropdown-toggle color-box selector" href="javascript:void(0);"></a><ul class="dropdown-menu arrow-box-up-right color-select pull-right"><li><span class="bg-color-green" data-widget-setstyle="dcmswidget-color-green" rel="tooltip" data-placement="left" data-original-title="Green Grass"></span></li><li><span class="bg-color-greenDark" data-widget-setstyle="dcmswidget-color-greenDark" rel="tooltip" data-placement="top" data-original-title="Dark Green"></span></li><li><span class="bg-color-greenLight" data-widget-setstyle="dcmswidget-color-greenLight" rel="tooltip" data-placement="top" data-original-title="Light Green"></span></li><li><span class="bg-color-purple" data-widget-setstyle="dcmswidget-color-purple" rel="tooltip" data-placement="top" data-original-title="Purple"></span></li><li><span class="bg-color-magenta" data-widget-setstyle="dcmswidget-color-magenta" rel="tooltip" data-placement="top" data-original-title="Magenta"></span></li><li><span class="bg-color-pink" data-widget-setstyle="dcmswidget-color-pink" rel="tooltip" data-placement="right" data-original-title="Pink"></span></li><li><span class="bg-color-pinkDark" data-widget-setstyle="dcmswidget-color-pinkDark" rel="tooltip" data-placement="left" data-original-title="Fade Pink"></span></li><li><span class="bg-color-blueLight" data-widget-setstyle="dcmswidget-color-blueLight" rel="tooltip" data-placement="top" data-original-title="Light Blue"></span></li><li><span class="bg-color-teal" data-widget-setstyle="dcmswidget-color-teal" rel="tooltip" data-placement="top" data-original-title="Teal"></span></li><li><span class="bg-color-blue" data-widget-setstyle="dcmswidget-color-blue" rel="tooltip" data-placement="top" data-original-title="Ocean Blue"></span></li><li><span class="bg-color-blueDark" data-widget-setstyle="dcmswidget-color-blueDark" rel="tooltip" data-placement="top" data-original-title="Night Sky"></span></li><li><span class="bg-color-darken" data-widget-setstyle="dcmswidget-color-darken" rel="tooltip" data-placement="right" data-original-title="Night"></span></li><li><span class="bg-color-yellow" data-widget-setstyle="dcmswidget-color-yellow" rel="tooltip" data-placement="left" data-original-title="Day Light"></span></li><li><span class="bg-color-orange" data-widget-setstyle="dcmswidget-color-orange" rel="tooltip" data-placement="bottom" data-original-title="Orange"></span></li><li><span class="bg-color-orangeDark" data-widget-setstyle="dcmswidget-color-orangeDark" rel="tooltip" data-placement="bottom" data-original-title="Dark Orange"></span></li><li><span class="bg-color-red" data-widget-setstyle="dcmswidget-color-red" rel="tooltip" data-placement="bottom" data-original-title="Red Rose"></span></li><li><span class="bg-color-redLight" data-widget-setstyle="dcmswidget-color-redLight" rel="tooltip" data-placement="bottom" data-original-title="Light Red"></span></li><li><span class="bg-color-white" data-widget-setstyle="dcmswidget-color-white" rel="tooltip" data-placement="right" data-original-title="Purity"></span></li><li><a href="javascript:void(0);" class="dcmswidget-remove-colors" data-widget-setstyle="" rel="tooltip" data-placement="bottom" data-original-title="Reset widget color to default">Remove</a></li></ul>';
					...
					if ( self.o.toggleButton === true && tWidget.data( 'widget-togglebutton' ) ===
						...
						if ( tWidget.data( 'widget-collapsed' ) === true || tWidget.hasClass(
							'dcmswidget-collapsed' ) ) {
							var toggleSettings = self.toggleClass[1];
						} else {
							toggleSettings = self.toggleClass[0];
						}
						var toggleBtn =
							'<a href="#" class="button-icon dcmswidget-toggle-btn" rel="tooltip" title="Collapse" data-placement="bottom"><i class="' +
								toggleSettings + '"></i></a>';
					} else {
						toggleBtn = '';
					}
					...
					if ( self.o.refreshButton === true && tWidget.data( 'widget-refreshbutton' ) !=
						...
						var refreshBtn =
							'<a href="#" class="button-icon dcmswidget-refresh-btn" data-loading-text="&nbsp;&nbsp;Loading...&nbsp;" rel="tooltip" title="Refresh" data-placement="bottom"><i class="' +
					...
					if ( refreshBtn != '' || deleteBtn != '' || customBtn != '' || fullscreenBtn != '' ||
						editBtn != '' || toggleBtn != '' ) {
						thisHeader.prepend( '<div class="dcmswidget-ctrls">' + formatButtons +
							'</div>' );
					}
					...
					if ( self.o.sortable === true && tWidget.data( 'widget-sortable' ) === undefined ) {
						tWidget.addClass( 'dcmswidget-sortable' );
					}
					 ...
					 **/
					thisHeader.append(
						'<span class="dcmswidget-loader"><i class="fa fa-refresh fa-spin"></i></span>'
					);
			...
			$( ".dcmswidget header [rel=tooltip]" ).tooltip();
			...
			self.obj.find( '[data-widget-load]' ).each( function ()
			{
				...
				if ( !thisItem.find( '.dcmswidget-ajax-placeholder' ).length ) {

					/**
					 * Append a AJAX placeholder.
					 **/
					thisItem.children( 'widget-body' )
						.append( '<div class="dcmswidget-ajax-placeholder">' + self.o.loadingLabel +
							'</div>' );
			...
			if ( self.o.sortable === true && jQuery.ui ) {
				...
				sortItem.sortable( {
					items: sortItem.find( '.dcmswidget-sortable' ),
					...
					delay: 200,
					cancel: '.button-icon, #dcmswidget-fullscreen-mode > div',
					zIndex: 10000,
		...
		_clickEvents: function ()
		{
			 ...
			 **/
			self.widget.on( clickEvent, '.dcmswidget-toggle-btn', function ( e )
			{
			...
			function heightFullscreen()
			{
				if ( $( '#dcmswidget-fullscreen-mode' )
					...
					var heightWindow = $( window )
						.height();
					var heightHeader = $( '#dcmswidget-fullscreen-mode' )
						.find( self.o.widgets )
						.children( 'header' )
						.height();
			 ...
			 **/
			self.widget.on( clickEvent, '.dcmswidget-fullscreen-btn', function ( e )
			{
				...
				if ( $( '#dcmswidget-fullscreen-mode' )
					...
					thisWidget.unwrap( '<div>' )
						...
						.removeAttr( 'style' )
						.end()
						.find( '.dcmswidget-fullscreen-btn' )
						.children()
					 ...
					 **/
					if ( thisWidgetContent.hasClass( 'dcmswidget-visible' ) ) {
						thisWidgetContent.hide()
							.removeClass( 'dcmswidget-visible' );
					}
					 ...
					 **/
					thisWidget.wrap( '<div id="dcmswidget-fullscreen-mode"/>' )
						.parent()
						.find( '.dcmswidget-fullscreen-btn' )
						.children()
						...
						.parents( self.pwCtrls )
						.children( 'a:not(.dcmswidget-fullscreen-btn)' )
						.hide();
			 ...
			 **/
			self.widget.on( clickEvent, '.dcmswidget-edit-btn', function ( e )
			{
			...
			self.widget.on( clickEvent, '[data-widget-setstyle]', function ( e )
			{
				...
				$( this )
					...
					.removeClassPrefix( 'dcmswidget-color-' )
					.addClass( val );
			 ...
			 * Allow users to show/hide a edit box.
			 **/
			self.widget.on( clickEvent, '.dcmswidget-custom-btn', function ( e )
			{
			 ...
			 **/
			self.widget.on( clickEvent, '.dcmswidget-delete-btn', function ( e )
			{
			 ...
			 **/
			self.widget.on( clickEvent, '.dcmswidget-refresh-btn', function ( e )
			{
