...
csccParseXml.prototype =
{
    ...
    getSensePath: function() {
        ...
        path = path.toLowerCase(); // @dw2k make lower case if the tag has upper cases
        // the tag will not modify :)
	
        if (this.attributeName != "") {
            path += cscc.sensePathSeparator + this.attributeName;
            if (this.attributeValue != "") {
                path += cscc.sensePathSeparator + this.attributeValue;
            }
        }
        return path;
    },
