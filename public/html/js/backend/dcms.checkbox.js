 ...
 *  
 *  
 *  modified by dw2k (remove select box trasformation)
 */
;
(function ($) {
    ...
    $.Zebra_TransForm = function (elements, options) {
        ...
        var update = function (remove)
        {
            ...
            elements.each(function () {
                ...
                if ($element.hasClass('inputC') || $element.hasClass('inputR') || $element.data('Zebra_TransForm_Wrapper')) {
                    return;
                }
                ...
                if (type) {
                    ...
                    if (!(type === 'Select' && (attributes.multiple || attributes.size))) {
                        ...
                        if (remove) {
                            ...
                            if (attributes.disabled && plugin.settings.style_disabled_labels) {
                                ...
                                label = $('label[for="' + Tools.escapeJqueryRegex($element.attr('id')) + '"]');
                        ...
                        wrapper = $('<i>', {'class': 'Zebra_TransForm_Wrapper'}); /*.css({
                        ...
                        $replacement = $('<div>', {'class': 'Zebra_TransForm_' + type + (type === 'Radio' ? ' Zebra_TransForm_Radio_' + n : '')}).
                                // the replacement div will be invisible for now
                                css('visibility', 'hidden');

                        /**
                         * Reset event by dw2k for the DreamCMS 3.0
                         */
                        $replacement.unbind('doReset.checkboxed').bind('doReset.checkboxed', function () {

                            if ($(this).hasClass('Zebra_TransForm_Checkbox'))
                            {
                                var defaultValue = $element.attr('default');
                                if (defaultValue === 'on') {
                                    $(this).addClass('Zebra_TransForm_Checkbox_Checked');
                                }
                                else {
                            ...
                            {
                                if ($(this).prev().attr('default') !== 'on') // test the input field attr default
                                {
                                    $(this).removeClass('Zebra_TransForm_Radio_Checked');
                                }
                                else
                                {
                                    $(this).addClass('Zebra_TransForm_Radio_Checked');
                                }
                            }
                        });
                        ...
                        // if element is a select box
                            ...
                            if (attributes.disabled)
                                $replacement.addClass('Zebra_TransForm_Select_Disabled');
                            ...
                            _bind($element, {
                                ...
                                'change.Zebra_TransForm': function () {
                                    ...
                                    if (!$(this).attr('disabled')) {
                                        ...
                                        if (type === 'Checkbox')
                                        {
                                            if (this.checked || $(this).is(':checked') || $(this).prop('checked')) {
                                            ...
                                            var name = n = $(this).attr('name');
                                            name = Tools.escapeJqueryRegex(name);
                                            ...
                                            $('.Zebra_TransForm_Radio_' + n).each(function () {
                                                // remove a class from the replacement element
                                                $(this).removeClass('Zebra_TransForm_Radio_Checked');
                                            });

                                            if (this.checked || $(this).prop('checked') || $(this).is(':checked')) {
                                                $(this).next().addClass('Zebra_TransForm_Radio_Checked');
                                                $(this).attr('checked', 'checked');
                                                $(this).prop('checked', true);
                                            }
                                            else {
                                                $(this).next().removeClass('Zebra_TransForm_Radio_Checked');
                                                $(this).removeAttr('checked', 'checked');
                                                $(this).prop('checked', false);
                                            }
                                            ...
                                            // set the "checked" attribute
                                            if ($(this).next().hasClass('Zebra_TransForm_Radio_Checked'))
                                            {
                            ...
                            if (events)
                                ...
                                for (var event_type in events)
                                    ...
                                    for (var idx in events[event_type])
                                        ...
                                        $replacement.bind((type !== 'Select' && event_type === 'change' ? 'click.checkbox' : event_type), $.proxy(events[event_type][idx].handler, element));
                    ...
                    // if element is disabled and disabled labels need to be styled
                    if (attributes.disabled && plugin.settings.style_disabled_labels && $element.attr('id')) {
