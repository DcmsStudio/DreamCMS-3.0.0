...
(function (t) {
    "use strict";
    var e, i, s, r = t.fn.animate, n = t.fn.stop, a = true, o = function (t, e) {
    ...
    }, l = {overwrite: 1, delay: 1, useFrames: 1, runBackwards: 1, easeParams: 1, yoyo: 1, immediateRender: 1, repeat: 1, repeatDelay: 1, autoCSS: 1}, _ = function (t, e) {
        for (var i in l)
        ...
        return m = function (i) {
            if (d)
                for (var s = d.length; --s > - 1; )
                    e.to(T, t.fx.off ? 0 : g.duration / 1e3, d[s]);
