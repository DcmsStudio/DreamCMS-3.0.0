...
$.extend($.ui, { datetimepicker: { version: "1.0.0"} });
    ...
    $.extend(Datetimepicker.prototype, {
        ...
        */
        ...
        _generateHTML: function(inst) {
            ...
            var currentDate = this._daylightSavingAdjust((!inst.currentDay ? new Date(today.getFullYear(), today.getMonth(), today.getDate()) : new Date(inst.currentYear, inst.currentMonth, inst.currentDay)));
    ...
    $.datetimepicker.uuid = dpuuid; //new Date().getTime();
    $.datetimepicker.version = "1.8";
