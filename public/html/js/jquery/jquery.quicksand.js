        ...
        return this.each(function (i) {
            ...
            if (!options.atomic) {
                ...
                for (i = 0; i < animationQueue.length; i++) {
                    animationQueue[i].element.css('position', 'auto').stop().animate(animationQueue[i].animation, options.duration, options.easing, postCallback);
                }
            } else {
