...
(function($) {
    ...
    Timepicker.prototype = {
        init: function()
        {
            ...
            this._colonPos = -1;
            this._visible = false;
            this.tpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker" style="width:30em; display: none; position: absolute;"></div>');
            this._generateHtml();
            ...
            var prepare = function(selector, type)
            {
                $(selector).each(function() {
                    ...
                    e.bind('click', function() {
                        ...
                        if ((type == 'hour') && $('#ui-timepicker-pm').hasClass('ui-state-active'))
                            time += 12;
