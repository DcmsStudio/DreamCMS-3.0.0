    ...
    function jqPlot() {
        ...
        this.init = function(target, data, options) {
            ...
            for (var i=0; i<$.jqplot.preInitHooks.length; i++) {
                if ($.jqplot.preInitHooks[i] !== undefined) $.jqplot.preInitHooks[i].call(this, target, data, options);
            }

            for (var i=0; i<this.preInitHooks.hooks.length; i++) {
                if (this.preInitHooks.hooks[i] !== undefined) this.preInitHooks.hooks[i].call(this, target, data, options);
            }
        ...
        this.draw = function(){
            if (this.drawIfHidden || this.target.is(':visible')) {
                ...
                for (var i=0; i<$.jqplot.postDrawHooks.length; i++) {
                    if ( $.jqplot.postDrawHooks[i] ) $.jqplot.postDrawHooks[i].call(this);
                }

                for (var i=0; i<this.postDrawHooks.hooks.length; i++) {
                    if ( this.postDrawHooks.hooks[i] ) this.postDrawHooks.hooks[i].call(this);
                }
