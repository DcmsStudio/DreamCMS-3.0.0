 ...
 */
class Messenger_Action_Createfolder extends Controller_Abstract
{
	...
	public function execute ()
	{
		...
		$this->db->query('INSERT INTO %tp%messages_folders (userid,title,description) VALUES(?, ?, ?)', User::getUserId(), $name, '');
