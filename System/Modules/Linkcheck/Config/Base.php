...
class Linkcheck_Config_Base
{
	...
	public static function getPermissions ( $getBackend = false )
	{
		...
		else
		{
			return array (
				...
				'access-items' => array (
					'index' => array (
						trans('darf den Linkchecker benutzen'),
						0
					)
				)
			);
	...
	public static function getModulDefinition ()
	{
		...
		return array (
			'dockurl'           => 'admin.php?adm=linkcheck',
			'modulelabel'       => trans('Linkchecker'),
	...
	public static function registerBackedMenu ()
	{
		...
		$menu = array (
			'label'       => trans('Linkchecker'),
			'description' => null,
			'icon'        => null,
			'action'      => ''
		);

		Menu::addMenuItem('tools', 'linkcheck', $menu);
	}
		...
		return array (
			array (
				...
				'items' => array (
					...
					array (
						'label'    => trans('Linkchecker beenden'),
						'call'     => 'closeApp',
						'shortcut' => 'CMD-E'
					)
				)
