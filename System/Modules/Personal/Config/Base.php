...
class Personal_Config_Base
{
	...
	public static function getModulDefinition ()
	{
		...
		return array (
			'modulelabel'       => trans('Personalizer'),
			'moduledescription' => trans('Verwaltet Persönliche Einstellungen der Benutzer im Frontend und Backend.'),
			'version'           => '0.1',
			'allowmetadata'     => false,
		);
	}
