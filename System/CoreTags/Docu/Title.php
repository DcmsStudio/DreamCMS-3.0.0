...
class Tag_Docu_Title extends DCMS_ContentProvider
{
	...
	public static function render($tag)
    {
        ...
        $__dat = self::getCacheData('documentation');
        $Applicationitems = DCMS_Applicationitems::getInstance();
        ...
        if ($_id && !$_alias)
        {
            ...
            else
            {
                ...
                self::setCacheData('documentation', $r );
            }
        }
        else
        {
