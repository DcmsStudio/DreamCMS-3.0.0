 ...
 * @file         Base.php
 */
class Addon_Localeselect_Config_Base
{
	...
	public static function getModulDefinition()
	{
		...
		Registry::getObject('Event')->bindevent('remove.plugin', function() {
			Cache::delete( 'LocaleselectPlugin' );
		});
		...
		return array(
			'modulelabel'       => trans( 'Sprachauswahl' ),
			'moduledescription' => trans( 'Sprachauswahl Plugin ermöglicht es die Sprache der Inhalte umzuschalten' ),
			'version'           => '0.1',
			'run'               => true,
			'config'            => false,
			'allowmetadata'     => false,
