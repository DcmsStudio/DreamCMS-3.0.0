...
(function($) {
    ...
    $.jCal = function(target, opt) {
        opt = $.extend({
            ...
            dow: ['S', 'M', 'D', 'M', 'D', 'F', 'S'], // days of week - change this to reflect your dayOffset
            ml: ['Januar', 'Februar', 'M�rz', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'],
            ms: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dez'],
