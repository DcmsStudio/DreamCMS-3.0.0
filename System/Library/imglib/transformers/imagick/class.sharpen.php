 ...
 * @file        class.sharpen.php
 */
class ImageTransformationSharpen
{

    public static function getTitle()
    {
        return trans( 'Bild schärfen' );
    }

    public static function getDescription()
    {
        return trans( 'Schärfen Sie das Bild.' );
    }
    ...
    {
        $radius = isset( $params[ 'radius' ] ) ? $params[ 'radius' ] : 2;
        $sigma  = isset( $params[ 'sigma' ] ) ? $params[ 'sigma' ] : 1;
