...
class ImageTransformationCrop
{
    ...
    public static function transform( $gd, $params )
    {
        ...
        else if ( is_numeric($params[ "valign" ]) || is_float($params[ "valign" ]) || is_integer($params[ "valign" ]))
        {
	        $y = $params[ "valign" ];
        }
        ...
        else if ( is_numeric( $params[ "align" ] ) || is_float($params[ "align" ]) || is_integer($params[ "align" ]) )
        {
	        $x = $params[ "align" ];
        }
        ...
        $out = ImageTools::getNewImage( $max_w, $max_h );
