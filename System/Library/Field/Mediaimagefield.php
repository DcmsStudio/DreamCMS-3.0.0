 ...
 * @file        Mediaimagefield.php
 */
class Field_MediaimageField extends Field_BaseField
{
    ...
    public static function renderField( $field )
    {
        ...
        if ( !$value )
        {
            return '<img src="dm/html/img/nophoto.gif" alt="" />';
        }
    ...
    public static function _renderField( $field )
    {
        ...
        $data[ 'attributes' ][ 'value' ]   = trans( 'Browse Mediacenter' );
        $data[ 'attributes' ][ 'onclick' ] = "openImageBrowser('/mediacenter/images', $('#{$field[ 'id' ]}') , true);";
