...
class Field_FileField extends Field_BaseField
{
	...
	{
		return array ( 'label', 'description', 'controls', 'value');
	}
	...
	public static function _renderField ( $field )
	{
		...
		{
			$data[ 'attributes' ][ 'data-tooltip' ]  = $field[ 'description' ];
		...
		$data[ 'attributes' ][ 'data-toggle' ] = 'file';
		...
		$html .= <<<EOF
		<div id="{$field[ 'id' ]}-preview" class="file-preview">
