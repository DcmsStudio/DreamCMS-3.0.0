...
class UTF8
{
    ...
    public static function transliterate_to_ascii( $str, $case = 0 )
    {
        ...
        {
            require LIBRARY_PATH . 'utf8/' . __FUNCTION__ . '.php';
    ...
    {
        if ( UTF8::$server_utf8 )
            return mb_strlen( $str, Application::$charset );
    ...
    {
        if ( UTF8::$server_utf8 )
            return mb_strpos( $str, $search, $offset, Application::$charset );
    ...
    {
        if ( UTF8::$server_utf8 )
            return mb_strrpos( $str, $search, $offset, Application::$charset );
    ...
    {
        if ( UTF8::$server_utf8 )
            return ($length === NULL) ? mb_substr( $str, $offset, mb_strlen( $str ), Application::$charset ) : mb_substr( $str, $offset, $length, Application::$charset );
     ...
     * @param $offset
     * @param null $length
     * @internal param \input $string string
     * @internal param \replacement $string string
    ...
    {
        if ( UTF8::$server_utf8 )
            return mb_strtolower( $str, Application::$charset );
    ...
    {
        if ( UTF8::$server_utf8 )
            return mb_strtoupper( $str, Application::$charset );
     ...
     * @param int $pad_type
     * @internal param \input $string string
     * @internal param \desired $integer string length after padding
     * @internal param string $string to use as padding
     * @internal param \padding $string type: STR_PAD_RIGHT, STR_PAD_LEFT, or STR_PAD_BOTH
     * @return  string
     */
