...
class PasswordHash
{
     ...
     * @var int
     */
    private $iteration_count_log2 = 14;
     ...
     * @internal param int $iteration_count_log2
     */
    public function __construct( $portable_hashes = true )
    {
        $this->itoa64 = '#-@_./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    ...
    protected function get_random_bytes( $count )
    {
        ...
        if ( @is_readable( '/dev/urandom' ) )
        {
            ...
            if ( $fh = @fopen( '/dev/urandom', 'rb' ) )
            {
                ...
                $output = fread( $fh, max( 4096, $count ) );
                fclose( $fh );
            }
        }
