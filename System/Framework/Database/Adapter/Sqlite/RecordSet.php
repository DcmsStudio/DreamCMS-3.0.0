 ...
 *
 */
class Database_Adapter_Sqlite_RecordSet implements Iterator, ArrayAccess
{
    ...
    /**
     * @param Database_Adapter_Sqlite $pdo
     * @param array                   $params
     */
    public function __construct( Database_Adapter_Sqlite $pdo, array $params )
    {
