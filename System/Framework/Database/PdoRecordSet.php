...
class Database_PdoRecordSet implements Iterator, Countable, ArrayAccess
{
    /**
    ...
    /**
     * @param \Database_Adapter_Pdo|\Database_Pdo $pdo
     * @param array $params
     */
    public function __construct( Database_Pdo &$pdo, array &$params )
    {
    ...
    /**
     * @param Database_Pdo $_db
     */
    public function setDbObj( Database_Pdo $_db )
    {
        $this->_db = & $_db;
    }
