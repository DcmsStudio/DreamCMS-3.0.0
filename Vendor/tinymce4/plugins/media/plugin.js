...
tinymce.PluginManager.add('media', function(editor, url) {
	...
	function showDialog() {
		...
		if ( typeof editor.settings.media_browser_url === 'string' && editor.settings.media_browser_url != '' ) {
			var generalFormItems = [{
	...
	editor.addButton('media', {
		...
		onclick: showDialog,
		stateSelector: ['img[data-mce-object=video]', 'img[data-mce-object=iframe], img[data-mce-object=object]']
	});
