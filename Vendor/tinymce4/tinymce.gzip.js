!function () {
    ...
    function e(n, e, t) {
        ...
        var o = "";
        return o += i("plugin", e), o += i("theme", n), o += i("language", t), o && (u.core ? o += "&core=false" : u.core = !0, o = r.baseURL + "/tinymce.gzip.php?js=true" + o), o
    }

    function t(n) {
        if ("string" == typeof n)return n.split(/[, ]/);
        var e = [];
        if (n)for (var i = 0; i < n.length; i++)e = e.concat(t(n[i]));
        return e
    }
    ...
    var r, c, d, u = {}, s = [], l = [];
    r = {init: o, baseURL: a(), suffix: ".min"}, window.tinyMCE_GZ = {init: function (n, o) {
