...
LITBox.prototype = {
   ...
   setup: function(){
      ...
      switch(this.options.type){
         case 'window' : this.d4.innerHTML = '<div class="LB_contentInner">' + this.getAjax(this.mes) + '</div>';
            break;
         case 'alert' : this.d4.innerHTML = '<div class="LB_contentInner">' + this.mes + '</div>';
            break;
         case 'confirm' : this.d4.innerHTML = '<div class="LB_contentConfirm">' + this.mes + '</div>';
		 
		    this.cicon = document.createElement('div');
		    this.cicon.className='LB_contentConfirmIcon';
			this.cicon.innerHTML = '<span>Aufgabe ausführen?</span>';
			
			this.d3.appendChild(this.cicon);
			
            this.button_y = document.createElement('input');
            this.button_y.type='button';
			this.button_y.className='button mr5 ml5';
			...
			this.button_n.className='button mr5 ml5';
   ...
   getWindow: function(){
	  ...
	  this.minsize = this.options.width;
	  
     // this.d2.style.height = parseInt(this.options.height) + 'px';
	
	
	  this.dbox = document.createElement('div');
	  this.dbox.style.overflow = 'hidden';
	  this.dbox.className = 'box';
	  
	  this.d2.appendChild(this.dbox);
	  
      this.d3 = document.createElement('div');
      this.d2.appendChild(this.d3);
      this.d3.className='LB_closeAjaxWindow tableheader';
      this.d3.d2 = this.d2;
   ...
   tempf: function(){ eval(this.temp); },
   
   remove: function(){
      if(this.temp) eval(this.temp);
