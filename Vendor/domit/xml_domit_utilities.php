...
class DOMIT_Utilities {
	...
	*/
	public static function convertEntities($text, $definedEntities) {
	...
	*/
	public static function printUTF8Header($contentType = 'text/html') {
	...
	*/
	public static function fromArray (&$node, &$myArray) {
		if ($node->nodeType == DOMIT_DOCUMENT_NODE) {
			$docNode =& $node;
		}
		else {
