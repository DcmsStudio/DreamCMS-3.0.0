...
function T_trans($msgid) {
    if (_check_locale_and_function()) return trans($msgid);
    else return _trans($msgid);
}
function T_($msgid) {
...
function T_dcnptrans($domain, $context, $singular, $plural, $category) {
    if (_check_locale_and_function('dcnpgettext'))
        return dcnptrans($domain, $context, $single,
                           $plural, $number, $category);
    else
        return _dcnptrans($domain, $context, $single,
                            $plural, $number, $category);
}
...
if (!function_exists('gettext')) {
    ...
    function dcnptrans($domain, $context, $single, $plural,
                         $number, $category) {
      return _dcnptrans($domain, $context, $single, $plural,
                          $number, $category);
    }
}
